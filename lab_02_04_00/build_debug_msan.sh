...
if ! clang -std=c99 -Wall -Werror -Wextra -Wpedantic -Wfloat-equal -Wfloat-conversion -Wvla -fsanitize=memory -fPIE -fno-omit-frame-pointer -O0 -g -c -o "$dir/main.o" "$dir/main.c"
then
    exit 1
fi

...
if ! clang -std=c99 -Wall -Werror -Wextra -Wpedantic -Wfloat-equal -Wfloat-conversion -Wvla -fsanitize=address -fno-omit-frame-pointer -O0 -g -c -o "$dir/main.o" "$dir/main.c"
then
    exit 1
fi

# Компоновка исполняемого файла в случае успешной компиляции
clang -fsanitize=address -o "$dir/app.exe" "$dir/main.o" -lm
